...
const DropdownEditor = ({ value: cell, onFinishedEditing, initialValue }) => {
  ...
  return (
    <Select
      ...
      menuPlacement="auto"
      value={allowedValues.find((x) => x.value === selectedValue) || null}
      options={allowedValues.filter((x) => x.label.toLowerCase().includes(inputValue.toLowerCase()))}
...
export const DropDownCustomCells = {
  kind: GridCellKind.Custom,

  isMatch: (cell) => cell.data.kind === 'dropdown-custom-cell',
