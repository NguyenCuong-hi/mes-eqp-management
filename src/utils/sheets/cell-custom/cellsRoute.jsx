...
export const Editor = (p) => {
  ...
  const filteredData = useMemo(() => {
    ...
    const propertiesToSearch = ["routeCode", "routeName",];
...
export const CellsRoute = {
  kind: GridCellKind.Custom,
  isMatch: (c) => c.data.kind === 'cells-route',
  draw: (args, cell) => {
...
export const callGetCodeHelp = async (key, d) => {
  ...
  try {
    ...
    const result = await SearchRouteBy(searchData);
