...
function MachinePageTable({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_ERP_COLS_PAGE_MACHINE', []);
  });
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_MACHINE', newHidden);
      return newHidden;
    });
  };
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_MACHINE', uniqueCols);
      return uniqueCols;
    });
  };
  // Hàm ẩn cột
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([]);
    localStorage.removeItem('S_ERP_COLS_PAGE_MACHINE');
    localStorage.removeItem('H_ERP_COLS_PAGE_MACHINE');
    setShowMenu(null);
  };
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_MACHINE', updatedCols);
      return updatedCols;
    });
  }, []);
  ...
  const showDrawer = () => {
    ...
    const currentVisibleCols = loadFromLocalStorageSheet('S_ERP_COLS_PAGE_MACHINE', []).map((col) => col.id);
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_MACHINE', newCols);
        return newCols;
      });
      setHiddenColumns((prevHidden) => {
...
export default MachinePageTable;