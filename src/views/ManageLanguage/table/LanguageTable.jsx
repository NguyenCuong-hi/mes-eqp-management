...
function LanguageTable({
  ...
  const [hiddenColumns, setHiddenColumns] = useState(() => {
    return loadFromLocalStorageSheet('H_ERP_COLS_PAGE_LANGUAGE', []);
  });
  ...
  const updateHiddenColumns = (newHiddenColumns) => {
    setHiddenColumns((prevHidden) => {
      ...
      saveToLocalStorageSheet('H_ERP_COLS_PAGE_LANGUAGE', newHidden);
      return newHidden;
    });
  };
  ...
  const updateVisibleColumns = (newVisibleColumns) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_LANGUAGE', uniqueCols);
      return uniqueCols;
    });
  };
  // Hàm ẩn cột
  ...
  const handleReset = () => {
    ...
    setHiddenColumns([]);
    localStorage.removeItem('S_ERP_COLS_PAGE_LANGUAGE');
    localStorage.removeItem('H_ERP_COLS_PAGE_LANGUAGE');
    setShowMenu(null);
  };
  ...
  const onColumnMoved = useCallback((startIndex, endIndex) => {
    setCols((prevCols) => {
      ...
      saveToLocalStorageSheet('S_ERP_COLS_PAGE_LANGUAGE', updatedCols);
      return updatedCols;
    });
  }, []);
  ...
  const showDrawer = () => {
    ...
    const currentVisibleCols = loadFromLocalStorageSheet('S_ERP_COLS_PAGE_LANGUAGE', []).map((col) => col.id);
  ...
  const handleCheckboxChange = (columnId, isChecked) => {
    if (isChecked) {
      ...
      setCols((prevCols) => {
        ...
        saveToLocalStorageSheet('S_ERP_COLS_PAGE_LANGUAGE', newCols);
        return newCols;
      });
      setHiddenColumns((prevHidden) => {
